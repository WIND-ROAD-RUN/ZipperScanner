...
namespace cdm {
    ...
    public:
        ...
        int chongkongOut{ 0 };
        int tuojiOut{ 0 };
        int xiangjichufapaizhao1Out{ 0 };
        int xiangjichufapaizhao2Out{ 0 };
        int DOWarnRed{ 0 };
        int DOWarnGreen{ 0 };
        bool isQueya{ false };
        ...
        int imgRotateCount1{ 0 };
        int imgRotateCount2{ 0 };
    };
    ...
    inline SetConfig::SetConfig(const rw::oso::ObjectStoreAssembly& assembly)
    {
        ...
        auto tifeirongyufangdouItem = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$tifeirongyufangdou$"));
        if (!tifeirongyufangdouItem) {
            throw std::runtime_error("$variable$tifeirongyufangdou is not found");
        }
        tifeirongyufangdou = tifeirongyufangdouItem->getValueAsDouble();
        ...
        auto guanjiInItem = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$guanjiIn$"));
        if (!guanjiInItem) {
            throw std::runtime_error("$variable$guanjiIn is not found");
        }
        guanjiIn = guanjiInItem->getValueAsInt();
        ...
        auto xiangjichufapaizhao1OutItem = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$xiangjichufapaizhao1Out$"));
        if (!xiangjichufapaizhao1OutItem) {
            throw std::runtime_error("$variable$xiangjichufapaizhao1Out is not found");
        }
        xiangjichufapaizhao1Out = xiangjichufapaizhao1OutItem->getValueAsInt();
        auto xiangjichufapaizhao2OutItem = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$xiangjichufapaizhao2Out$"));
        if (!xiangjichufapaizhao2OutItem) {
            throw std::runtime_error("$variable$xiangjichufapaizhao2Out is not found");
        }
        xiangjichufapaizhao2Out = xiangjichufapaizhao2OutItem->getValueAsInt();
        auto DOWarnRedItem = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$DOWarnRed$"));
        if (!DOWarnRedItem) {
            throw std::runtime_error("$variable$DOWarnRed is not found");
        }
        DOWarnRed = DOWarnRedItem->getValueAsInt();
        auto DOWarnGreenItem = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$DOWarnGreen$"));
        if (!DOWarnGreenItem) {
            throw std::runtime_error("$variable$DOWarnGreen is not found");
        }
        DOWarnGreen = DOWarnGreenItem->getValueAsInt();
        ...
        auto imgRotateCount1Item = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$imgRotateCount1$"));
        if (!imgRotateCount1Item) {
            throw std::runtime_error("$variable$imgRotateCount1 is not found");
        }
        imgRotateCount1 = imgRotateCount1Item->getValueAsInt();
        auto imgRotateCount2Item = rw::oso::ObjectStoreCoreToItem(assembly.getItem("$variable$imgRotateCount2$"));
        if (!imgRotateCount2Item) {
            throw std::runtime_error("$variable$imgRotateCount2 is not found");
        }
        imgRotateCount2 = imgRotateCount2Item->getValueAsInt();
    }
    ...
    inline SetConfig::SetConfig(const SetConfig& obj)
    {
        ...
        tifeirongyufangdou = obj.tifeirongyufangdou;
        ...
        guanjiIn = obj.guanjiIn;
        chongkongOut = obj.chongkongOut;
        tuojiOut = obj.tuojiOut;
        xiangjichufapaizhao1Out = obj.xiangjichufapaizhao1Out;
        xiangjichufapaizhao2Out = obj.xiangjichufapaizhao2Out;
        DOWarnRed = obj.DOWarnRed;
        DOWarnGreen = obj.DOWarnGreen;
        isQueya = obj.isQueya;
        ...
        imgRotateCount1 = obj.imgRotateCount1;
        imgRotateCount2 = obj.imgRotateCount2;
    }
    ...
    inline SetConfig::operator rw::oso::ObjectStoreAssembly() const
    {
        ...
        auto tifeirongyufangdouItem = std::make_shared<rw::oso::ObjectStoreItem>();
        tifeirongyufangdouItem->setName("$variable$tifeirongyufangdou$");
        tifeirongyufangdouItem->setValueFromDouble(tifeirongyufangdou);
        assembly.addItem(tifeirongyufangdouItem);
        ...
        auto guanjiInItem = std::make_shared<rw::oso::ObjectStoreItem>();
        guanjiInItem->setName("$variable$guanjiIn$");
        guanjiInItem->setValueFromInt(guanjiIn);
        assembly.addItem(guanjiInItem);
        ...
        auto xiangjichufapaizhao1OutItem = std::make_shared<rw::oso::ObjectStoreItem>();
        xiangjichufapaizhao1OutItem->setName("$variable$xiangjichufapaizhao1Out$");
        xiangjichufapaizhao1OutItem->setValueFromInt(xiangjichufapaizhao1Out);
        assembly.addItem(xiangjichufapaizhao1OutItem);
        auto xiangjichufapaizhao2OutItem = std::make_shared<rw::oso::ObjectStoreItem>();
        xiangjichufapaizhao2OutItem->setName("$variable$xiangjichufapaizhao2Out$");
        xiangjichufapaizhao2OutItem->setValueFromInt(xiangjichufapaizhao2Out);
        assembly.addItem(xiangjichufapaizhao2OutItem);
        auto DOWarnRedItem = std::make_shared<rw::oso::ObjectStoreItem>();
        DOWarnRedItem->setName("$variable$DOWarnRed$");
        DOWarnRedItem->setValueFromInt(DOWarnRed);
        assembly.addItem(DOWarnRedItem);
        auto DOWarnGreenItem = std::make_shared<rw::oso::ObjectStoreItem>();
        DOWarnGreenItem->setName("$variable$DOWarnGreen$");
        DOWarnGreenItem->setValueFromInt(DOWarnGreen);
        assembly.addItem(DOWarnGreenItem);
        ...
        auto imgRotateCount1Item = std::make_shared<rw::oso::ObjectStoreItem>();
        imgRotateCount1Item->setName("$variable$imgRotateCount1$");
        imgRotateCount1Item->setValueFromInt(imgRotateCount1);
        assembly.addItem(imgRotateCount1Item);
        auto imgRotateCount2Item = std::make_shared<rw::oso::ObjectStoreItem>();
        imgRotateCount2Item->setName("$variable$imgRotateCount2$");
        imgRotateCount2Item->setValueFromInt(imgRotateCount2);
        assembly.addItem(imgRotateCount2Item);
        return assembly;
    }
